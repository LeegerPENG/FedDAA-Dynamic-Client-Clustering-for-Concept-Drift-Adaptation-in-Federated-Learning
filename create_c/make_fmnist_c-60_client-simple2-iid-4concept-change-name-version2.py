...
for i in range(client_number):
    ...
    for img, label in zip(clients_images[i], clients_labels[i]):
        ...
        fmnist_c.append(np.uint8(convert_img(img)))
    clients_images[i] = fmnist_c
...
test_fmnist_c, test_labels_1, test_labels_2, test_labels_3, test_labels_4 = [], [], [], [],[]
for img, label in zip(original_images_te, original_labels_te):
    ...
    test_fmnist_c.append(np.uint8(convert_img(img)))


client_1 = {'images': np.uint8(np.array(test_fmnist_c)),
              'labels': np.uint8(np.array(test_labels_1)),
              'type': 0}
client_2 = {'images': np.uint8(np.array(test_fmnist_c)),
              'labels': np.uint8(np.array(test_labels_2)),
              'type': 1}
client_3 = {'images': np.uint8(np.array(test_fmnist_c)),
              'labels': np.uint8(np.array(test_labels_3)),
              'type': 2}
client_4 = {'images': np.uint8(np.array(test_fmnist_c)),
